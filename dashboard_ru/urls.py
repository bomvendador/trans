...
urlpatterns = [
    ...
    url(r'^change_payment_failure/$', payments.change_payment_failure, name='change_payment_failre'),
    ...
    url(r'^new_testimonials_list/$', ru_views.get_new_testimonials_list, name='get_new_testimonials_list'),
